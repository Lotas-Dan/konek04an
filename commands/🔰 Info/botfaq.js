...
module.exports = {
    ...
    run: async (client, message, args, cmduser, text, prefix, es, ls, GuildSettings) => {
      ...
      //   const guild = client.guilds.cache.get("996497085077659720");
      //   if (!guild) return null;
      //   const members = await guild.members.fetch().catch(() => null);
      //   if (!members) return null;
      //   const membersWithRole = members.filter(member => member.roles.cache.has("996501991092142150"));
      //   return membersWithRole.size;
      // });
      const partnercount = null// membersWithRoleResult.find(count => count !== null);
      let menuoptions = [
        {
