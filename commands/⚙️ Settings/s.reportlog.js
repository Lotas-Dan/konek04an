...
module.exports = {
  name: "s.reportlog",
  category: "⚙️ Settings",
  aliases: ["sreportlog", "reportlog.s", "reportlogs"],
  cooldown: 5,
  usage: "s.reportlog  -->  React with the Emoji for the right action",
    ...
    try {
      ...
      async function first_layer() {
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.getAuthor('Report Log Setup', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/apple/285/bookmark_1f516.png', 'https://discord.gg/U5r2pMuRHG'))
