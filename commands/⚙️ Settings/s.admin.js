...
module.exports = {
  name: "s.admin",
  category: "⚙️ Settings",
  aliases: ["sadmin", "s.mod", "smod", "admins"],
  cooldown: 5,
  usage: "s.admin  -->  React with the Emoji for the right action",
  ...
  run: async (client, message, args, cmduser, text, prefix, es, ls, GuildSettings) => {
    ...
    try {
      ...
      async function first_layer(){
        ...
        .setColor(es.color)
        .setAuthor(client.getAuthor('Admin Setup', 'https://cdn.discordapp.com/emojis/892521772002447400.png?size=96', 'https://discord.gg/U5r2pMuRHG'))
                ...
                if (role) {
                  ...
                  try {
                    ...
                    if(index > -1) {
                      ...
                      await client.settings.set(message.guild.id+".adminroles", adminroles);
                    }
                    const newAdminRoles = await client.settings.get(message.guild.id+".adminroles");
                    return message.reply({embeds: [new MessageEmbed()
