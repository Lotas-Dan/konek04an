...
module.exports = {
  name: "s.antidiscord",
  category: "⚙️ Settings",
  aliases: ["antidiscord.s", "antidiscords", "s.discord", "sdiscord"],
  cooldown: 5,
  usage: "s.antidiscord  -->  React with the Emoji for the right action",
        ...
        let menuoptions = [
          {
            ...
            emoji: `${GuildSettings?.antidiscord?.enabled ? "998643650378616963" : "996538231644491907"}`
          },
          {
            value: "Settings",
        ...
        switch(menuoptionindex){
          case 0: {
            ...
            return message.reply({embeds: [new Discord.MessageEmbed()
              .setTitle(`<a:yes:996538231644491907> The Anti Discord Setup is now ${d2p(!previous)}!`)
              .setColor(es.color)
