...
module.exports = {
  name: "s.blacklist",
  category: "⚙️ Settings",
  aliases: ["sblacklist", "blacklist.s", "blacklists"],
  cooldown: 5,
  usage: "s.blacklist  -->  React with the Emoji for the right action",
  ...
  run: async (client, message, args, cmduser, text, prefix, es, ls, GuildSettings) => {
    try {
      ...
      async function first_layer(){
        ...
        .setColor(es.color)
        .setAuthor(client.getAuthor('Setup Blacklist', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/joypixels/291/stop-sign_1f6d1.png', 'https://discord.gg/U5r2pMuRHG'))
