  ...
  client.on("guildMemberUpdate", async (oM, nM) => {
    ...
    await dbEnsure(client.settings, nM.guild.id, {
      boost: {
        ...
        message: "",
        log: false,
        stopBoost: "<:server_boost:1002956684743934093> {member} **stopped Boosting us..** <:Cat_Sad:867722685949804565>",
        startBoost: "<:server_boost:1002956684743934093> {member} **has boosted us!** <:Light_Saber_Dancce:997956218884739112>",
        againBoost: "<:server_boost:1002956684743934093> {member} **has boosted us again!** <:Tada_WON:867724032207224833>",
      }
    })
