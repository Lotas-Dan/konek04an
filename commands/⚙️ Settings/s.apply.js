...
var emojis = require("../../configs/emojis.json");
var {
  dbEnsure
...
module.exports = {
  name: "s.apply",
  category: "⚙️ Settings",
  aliases: ["sapply", "apply.s", "applys", "s.application", "sapplication"],
  cooldown: 5,
  usage: "s.apply --> React with the Emoji for the right action",
  description: "Manage 100 different Application Systems",
  memberpermissions: ["ADMINISTRATOR"],
  type: "system",
  run: async (client, message, args, cmduser, text, prefix, es, ls, GuildSettings) => {
    let theemoji = "📜";
    let Konek0Official = client.guilds.cache.get("996497085077659720");
    if (Konek0Official) theemoji = "1004117610272669799";
    ...
    async function first_layer() {
      try {
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.getAuthor('Application Setup', 'https://cdn.discordapp.com/emojis/877653386747605032.png?size=96', 'https://discord.gg/U5r2pMuRHG'))
    ...
    async function second_layer(SetupNumber, menuoptiondata) {
      try {
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.getAuthor(SetupNumber + " Apply Setup", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/282/incoming-envelope_1f4e8.png", "https://discord.gg/U5r2pMuRHG"))
                                ...
                                msg.channel.awaitMessages({
                                  ...
                                  if (collected.first().content.toLowerCase() === "no") {
                                    ...
                                    if (!message.guild.me.roles) return message.reply({
                                      embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable25"])).setAuthor(client.getAuthor("<:no:998643650378616963> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                                        dynamic: true
                                      })))]
                                    })
            ...
            async function setup_without_channel_creation() {
              ...
              await pickmsg.channel.awaitMessages({filter: (m) => m.author.id === cmduser.id,
                  ...
                  if (channel) {
                    ...
                    throw "<:no:998643650378616963> ERROR";
                  }
                })
                .catch(e => {
                  errored = e
                    ...
                    message.reply({
                      ...
                      msg.channel.awaitMessages({
                        ...
                        if (collected.first().content.toLowerCase() === "no") {
                          ...
                          if (!message.guild.me.roles) return message.reply({
                            embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable58"])).setAuthor(client.getAuthor("<:no:998643650378616963> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                              dynamic: true
                            })))]
                          })
          ...
          case "acceptrole": {
            message.reply({
              ...
              msg.channel.awaitMessages({
                ...
                if (!message.guild.me.roles) return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable70"])).setAuthor(client.getAuthor("<:no:998643650378616963> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  })))]
                })
                ...
                if (guildrole.rawPosition <= botrole.rawPosition) {
                  ...
                  return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable71"])).setAuthor(client.getAuthor("<:no:998643650378616963> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    })))]
                  })
                }
            ...
            case "setrole": {
              message.reply({
                ...
                msg.channel.awaitMessages({
                  ...
                  if (!message.guild.me.roles) return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable81"])).setAuthor(client.getAuthor("<:no:998643650378616963> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    })))]
                  })
                  ...
                  if (guildrole.rawPosition <= botrole.rawPosition) {
                    ...
                    return message.reply({
                      embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable82"])).setAuthor(client.getAuthor("<:no:998643650378616963> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                        dynamic: true
                      })))]
                    })
                  }
            ...
            case "setrole": {
              message.reply({
                ...
                msg.channel.awaitMessages({
                  ...
                  if (!message.guild.me.roles) return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable100"])).setAuthor(client.getAuthor("<:no:998643650378616963> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    })))]
                  })
                  ...
                  if (guildrole.rawPosition <= botrole.rawPosition) {
                    ...
                    return message.reply({
                      embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable101"])).setAuthor(client.getAuthor("<:no:998643650378616963> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                        dynamic: true
                      })))]
                    })
                  }
            ...
            case "setrole": {
              message.reply({
                ...
                msg.channel.awaitMessages({
                  ...
                  if (!message.guild.me.roles) return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable119"])).setAuthor(client.getAuthor("<:no:998643650378616963> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    })))]
                  })
                  ...
                  if (guildrole.rawPosition <= botrole.rawPosition) {
                    ...
                    return message.reply({
                      embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable120"])).setAuthor(client.getAuthor("<:no:998643650378616963> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                        dynamic: true
                      })))]
                    })
                  }
            ...
            case "setrole": {
              message.reply({
                ...
                msg.channel.awaitMessages({
                  ...
                  if (!message.guild.me.roles) return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable140"])).setAuthor(client.getAuthor("<:no:998643650378616963> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    })))]
                  })
                  ...
                  if (guildrole.rawPosition <= botrole.rawPosition) {
                    ...
                    return message.reply({
                      embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable141"])).setAuthor(client.getAuthor("<:no:998643650378616963> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                        dynamic: true
                      })))]
                    })
                  }
            ...
            case "setrole": {
              message.reply({
                ...
                msg.channel.awaitMessages({
                  ...
                  if (!message.guild.me.roles) return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable161"])).setAuthor(client.getAuthor("<:no:998643650378616963> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    })))]
                  })
                  ...
                  if (guildrole.rawPosition <= botrole.rawPosition) {
                    ...
                    return message.reply({
                      embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable162"])).setAuthor(client.getAuthor("<:no:998643650378616963> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                        dynamic: true
                      })))]
                    })
                  }
          ...
          case "temprole":
            message.reply({
              ...
              msg.channel.awaitMessages({
                ...
                if (!message.guild.me.roles) return message.reply({
                  embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable183"])).setAuthor(client.getAuthor("<:no:998643650378616963> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                    dynamic: true
                  })))]
                })
                ...
                if (guildrole.rawPosition <= botrole.rawPosition) {
                  ...
                  return message.reply({
                    embeds: [new Discord.MessageEmbed().setFooter(client.getFooter(es)).setColor("RED").setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable184"])).setAuthor(client.getAuthor("<:no:998643650378616963> ERROR | Could not Access the Role", message.author.displayAvatarURL({
                      dynamic: true
                    })))]
                  })
                }
