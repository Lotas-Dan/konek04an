...
module.exports = {
  name: "s.dailyfact",
  category: "⚙️ Settings",
  aliases: ["sdailyfact", "dailyfact.s", "dailyfacts"],
  cooldown: 5,
  usage: "s.dailyfact  -->  React with the Emoji for the right action",
    ...
    try {
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.getAuthor('Daily Facts Setup', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/apple/285/page-with-curl_1f4c3.png', 'https://discord.gg/U5r2pMuRHG'))
