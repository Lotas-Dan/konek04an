...
module.exports = {
  name: "s.boostlog",
  category: "⚙️ Settings",
  aliases: ["sboostlog", "boostlogs"],
  cooldown: 5,
  usage: "s.boostlog <#Channel/disable>",
    ...
    try {
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.getAuthor('Boost-Log', 'https://cdn.discordapp.com/emojis/833402717950836806.gif?size=128&quality=lossless', 'https://discord.gg/U5r2pMuRHG'))
