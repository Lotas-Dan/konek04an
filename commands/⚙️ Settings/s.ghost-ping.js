...
module.exports = {
  name: "s.ghost-ping",
  category: "⚙️ Settings",
  aliases: ["sghost-ping-detector", "ghost-ping", "ghost-ping-detectors", "sghostping", "s.ghostping"],
  cooldown: 5,
  usage: "s.ghost-ping-detector  -->  React with the Emoji for the right action",
    ...
    try {
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.getAuthor('Ghost-Ping-Detector Setup', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/apple/285/bookmark_1f516.png', 'https://discord.gg/U5r2pMuRHG'))
                  ...
                  if (channel) {
                    try {
                      ...
                      return message.reply({embeds: [new Discord.MessageEmbed()
                        .setTitle(`<a:yes:996538231644491907> I will now send all detected Ghost Pings in \`${channel.name}\``)
                        .setColor(es.color)
