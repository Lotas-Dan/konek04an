        ...
        if (args[0].toLowerCase() === "start") {
            try{
                ...
                let options = {
                    ...
                    bonusEntries: [],
                    messages: {
                        inviteToParticipate: "***React with <a:tadaa:1008107690289012746> to participate!***\n",
                        drawing: "> Ends: {timestamp}\n",
                        hostedBy: "**Hosted by:** {this.hostedBy}",
                        dropMessage: "Be the first to react with <a:tadaa:1008107690289012746>",
                        noWinner: "\n**Giveaway cancelled!**\n> No valid participations. :cry:",
                        endedAt: "Ends at", 
                        giveaway: '<a:tadaa:1008107690289012746> **GIVEAWAY STARTED** <a:tadaa:1008107690289012746>',
                        giveawayEnded: '<a:tada_end:1008113657361743983> **GIVEAWAY ENDED** <a:tada_end:1008113657361743983>',
            ...
            client.giveawaysManager.reroll(giveaway.messageId, { winnerCount: !isNaN(args[1]) ? Number(args[1]) : 1})
                ...
                .catch((e) => {
                    if (e.startsWith(`Giveaway with message Id ${giveaway.messageId} is not ended.`)) {
                        ...
                        console.error(e);
                        message.reply({content : '<:no:998643650378616963> **An error occured...**```' + String(e.message).substring(0, 1900) + "```"});
                    }
                });
