...
module.exports = {
  name: "s.antiselfbot",
  category: "⚙️ Settings",
  aliases: ["sselfbot", "antiselfbot.s", "antiselfbots", "s.newaccount"],
  cooldown: 5,
  usage: "s.antiselfbot  -->  React with the Emoji for the right action",
    ...
    try {
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor('Anti-Self-Bot', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/microsoft/310/hammer_1f528.png', 'https://discord.gg/U5r2pMuRHG')
