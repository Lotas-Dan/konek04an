...
module.exports = {
  name: "s.aichat",
  category: "⚙️ Settings",
  aliases: ["saichat", "aichat.s", "saichat"],
  cooldown: 5,
  usage: "s.aichat  -->  React with the Emoji for the right action",
    ...
    try {
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor('Ai-Chat', 'https://cdn.discordapp.com/emojis/771804364582420532.gif?size=96', 'https://discord.gg/U5r2pMuRHG')
