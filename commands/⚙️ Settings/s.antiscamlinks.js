...
module.exports = {
  name: "s.antiscamlinks",
  category: "⚙️ Settings",
  aliases: ["sscamlinks","antiscamlinkss.s", "antiscamlinks.s", "antiscamlinkss"],
  cooldown: 5,
  usage: "s.antiscamlinks  -->  React with the Emoji for the right action",
        ...
        let menuoptions = [
          {
            ...
            emoji: `${GuildSettings?.antidiscordscam?.enabled ? "998643650378616963" : "1004118485573570580"}`
          },
          {
            value: "Settings",
          ...
          case 1: {
           let thesettings = await client.settings.get(`${message.guild.id}.antidiscordscam`)
            return message.reply({embeds: [new Discord.MessageEmbed()
              ...
              .setColor(es.color)
              .setDescription(`**Enabled:** ${thesettings.enabled ? "<a:yes:996538231644491907>" : "<:no:998643650378616963>"}`.substring(0, 2048))
