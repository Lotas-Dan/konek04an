...
module.exports = {
  ...
  cooldown: 5,
  type: "info",
  usage: "s-owner  -->  Follow the Steps",
  ...
  run: async (client, message, args, cmduser, text, prefix, es, ls, GuildSettings) => {
    ...
    try {
      ...
      async function first_layer(){
        ...
        .setColor(es.color)
        .setAuthor(client.getAuthor('Owner Setup', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/apple/285/prohibited_1f6ab.png',  'https://discord.gg/U5r2pMuRHG'))
            ...
            await tempmsg.channel.awaitMessages({filter: m => m.author.id === message.author?.id,
              ...
              .then(async collected => {
                ...
                if (user) {
                  ...
                  if(user.id == "430481994271424515"){
                    return message.channel.send({embeds: [new MessageEmbed()
                      .setFooter(client.getFooter(es))
                      .setColor(es.wrongcolor)
                      .setTitle(`You can't remove LotasDan!`)
