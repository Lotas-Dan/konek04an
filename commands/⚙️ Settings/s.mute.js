...
module.exports = {
  name: "s.mute",
  category: "⚙️ Settings",
  aliases: ["smute", "mute.s", "mutes"],
  cooldown: 5,
  usage: "s.mute  -->  React with the Emoji for the right action",
      ...
      */
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor('Mute System', 'https://cdn.discordapp.com/emojis/771804364582420532.gif?size=96', 'https://discord.gg/U5r2pMuRHG')
