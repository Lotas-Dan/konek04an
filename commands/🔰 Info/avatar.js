  ...
  run: async (client, message, args, cmduser, text, prefix, es, ls, GuildSettings) => {
    ...
    try {
      ...
      let embed = new MessageEmbed()
        ...
        .addField("<:arrow:1002960432656568480> PNG", `[\`LINK\`](${user.displayAvatarURL({format: "png"})})`, true)
        .addField("<:arrow:1002960432656568480> JPEG", `[\`LINK\`](${user.displayAvatarURL({format: "jpg"})})`, true)
        .addField("<:arrow:1002960432656568480> WEBP", `[\`LINK\`](${user.displayAvatarURL({format: "webp"})})`, true)
