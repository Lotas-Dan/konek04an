...
module.exports = {
  name: "s.antilink",
  category: "⚙️ Settings",
  aliases: ["antilinks.s", "antilink.s", "antilinks", "s.links", "slinks"],
  cooldown: 5,
  usage: "s.antilink  -->  React with the Emoji for the right action",
        ...
        let menuoptions = [
          {
            ...
            emoji: `${GuildSettings?.antilink?.enabled ? "998643650378616963" : "1004118485573570580"}`
          },
          {
            value: "Settings",
