...
module.exports = {
  name: "s.suggestion",
  category: "⚙️ Settings",
  aliases: ["ssuggestion", "suggestions", "suggests", "suggestion.s", "suggest.s", "s.suggest", "ssuggest"],
  cooldown: 5,
  usage: "s.suggestion  -->  React with the Emoji for the right action",
  ...
  run: async (client, message, args, cmduser, text, prefix, es, ls, GuildSettings) => {
    try {
      await dbEnsure(client.settings, message.guild.id, {
        suggest: {
          channel: "",
          approvemsg: `<a:yes:996538231644491907> Accepted Idea! Expect this soon.`,
          denymsg: `<:no:998643650378616963> Thank you for the feedback, but we are not interested in this idea at this time.`,
          maybemsg: `💡 We are thinking about this idea!`,
          duplicatemsg: `💢 This is a duplicated Suggestion`,
          soonmsg: `👌 Expect this Feature Soon!`,
          statustext: `<a:loading:1002959255348981852> Waiting for Community Feedback, please vote!`,
          footertext: `Want to suggest / Feedback something? Simply type in this channel!`,
          approveemoji: `996538231644491907`,
          denyemoji: `998643650378616963`,
        }
      });
      first_layer()
      async function first_layer() {
        ...
        //define the embed
        let MenuEmbed = new MessageEmbed().setColor(es.color).setAuthor('Suggestion System', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/282/light-bulb_1f4a1.png', 'https://discord.gg/U5r2pMuRHG').setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-ticket"]["variable2"]))
        //send the menu msg
