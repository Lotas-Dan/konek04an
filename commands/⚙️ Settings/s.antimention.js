...
module.exports = {
  name: "s.antimention",
  category: "⚙️ Settings",
  aliases: ["antimention.s", "antimentions", "s.mention", "smention"],
  cooldown: 5,
  usage: "s.antimention  -->  React with the Emoji for the right action",
        ...
        switch(menuoptionindex){
          ...
          case 2: {
            ...
            return message.reply({embeds: [new Discord.MessageEmbed()
              ...
              .setColor(es.color)
              .setDescription(`**Enabled:** ${thesettings.enabled ? "<a:yes:996538231644491907>" : "<a:yes:996538231644491907>"}\n\n**Allowed Mentions / Message:** \`${thesettings.limit} Pings\``.substring(0, 2048))
              .setFooter(client.getFooter(es))]}
            );
          } break;
          case 3: {
