...
module.exports = {
  name: "s.counter",
  category: "⚙️ Settings",
  aliases: ["scounter", "counters", "s.numbercounter", "snumbercounter", "numbercounter.s", "numbercounters"],
  cooldown: 5,
  usage: "s.counter  -->  React with the Emoji for the right action",
  ...
  run: async (client, message, args, cmduser, text, prefix, es, ls, GuildSettings) => {
    ...
    try {
      ...
      async function first_layer(){
        ...
        .setColor(es.color)
        .setAuthor(client.getAuthor('Number Counter Setup', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/emojidex/112/input-symbol-for-numbers_1f522.png', 'https://discord.gg/U5r2pMuRHG'))
