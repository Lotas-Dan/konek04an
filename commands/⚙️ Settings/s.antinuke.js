...
module.exports = {
  name: "s.antinuke",
  category: "⚙️ Settings",
  aliases: ["antinuke.s", "antinukes", "antinukesystem", "santinuke"],
  cooldown: 5,
  usage: "s.antinuke --> React with the Emoji for the right action",
  ...
  run: async (client, message, args, cmduser, text, prefix, es, ls, GuildSettings) => {
    ...
    if(message.author?.id != message.guild.ownerId){
      if(message.author?.id != "430481994271424515")
    ...
    try {
      ...
      async function first_layer(){
        ...
        .setColor(es.color)
        .setAuthor('Anti Nuke Setup', 'https://cdn.discordapp.com/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png', 'https://discord.gg/U5r2pMuRHG')
        ...
        async function menuselection(menu) {
          ...
          if(menu?.values[0] == "Information"){
            ...
            let MenuEmbed = new Discord.MessageEmbed()
            .setColor(es.color)
            .setAuthor('Anti Nuke Settings', 'https://cdn.discordapp.com/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png', 'https://discord.gg/U5r2pMuRHG')
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author?.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:leaves:1002958695770103928> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Bot add__ Whitelist (module)!**`.substring(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author?.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:leaves:1002958695770103928> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Kick/Ban__ Whitelist (module)!**`.substring(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author?.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:leaves:1002958695770103928> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Create Role__ Whitelist (module)!**`.substring(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author?.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:leaves:1002958695770103928> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Delete Role__ Whitelist (module)!**`.substring(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author?.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:leaves:1002958695770103928> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Channel Create__ Whitelist (module)!**`.substring(0, 2048))
                ...
                await tempmsg.channel.awaitMessages({filter: m => m.author.id == message.author?.id, 
                  ...
                  .then(async collected => {
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      ...
                      .setColor(es.color)
                      .setDescription(`<:leaves:1002958695770103928> **Removed \`[${removedroles.length}] Roles\` and \`[${removedusers.length}] Users\` from the __Anti Channel Delete__ Whitelist (module)!**`.substring(0, 2048))
              ...
              menuoptions = [
                {
                  ...
                  emoji: await client.Anti_Nuke_System.get(message.guild.id+ ".all.enabled") ? "998643650378616963": "996538231644491907"
                },
                {
                  value: "Set Logger",
                ...
                },
                {
                  ...
                  emoji: await client.Anti_Nuke_System.get(message.guild.id+ ".all.showwhitelistlog") ? "998643650378616963": "996538231644491907"
                },
                {
                  value: "Modify Quarantine Role",
                  description: "Remove/add the Qurantine Role",
                  emoji: "1006321993227960372"
                },
                {
                  value: "Anti Bot Add",
                ...
                if(String(index) == "0"){
                   ...
                   */
                    ...
                    async function first_layer(){
                      menuoptions = [
                        {
                          ...
                          emoji: await client.Anti_Nuke_System.get(message.guild.id, `${thekey}.enabled`) ? "998643650378616963": "996538231644491907"
                        },
                        {
                          value: "Remove Roles / Day",
                          description: `Amount of Actions / Day to remove the Roles`,
                          emoji: "996540401144049664"
                        },
                        {
                      ...
                      let MenuEmbed = new Discord.MessageEmbed()
                        .setColor(es.color)
                        .setAuthor('Antinuke Setup', 'https://media.discordapp.net/attachments/820695790170275871/869657327941324860/PS7lwz7HwAAAABJRU5ErkJggg.png', 'https://discord.gg/U5r2pMuRHG')
                      ...
                      client.on('interactionCreate', async (menu) => {
                        if (menu?.message.id === menumsg.id) {
                          if (menu?.user.id === cmduser.id) {
                            if(used33) return menu?.reply({content: `<:no:998643650378616963> You already selected something, this Selection is now disabled!`, ephemeral: true})
            ...
            return menu?.reply({content: "<a:yes:996538231644491907> **Now using the Suggested Settings!**", embeds: [new MessageEmbed()
              .setColor(es.color)
              .setFooter(client.getFooter(es))
              .setTitle(`${await client.Anti_Nuke_System.get(message.guild.id+ ".all.enabled") ? "<a:yes:996538231644491907> __**The Anti Nuke is enabled!**__": "<:no:998643650378616963> __**The Anti Nuke is disabled!**__"}`)
              .addField(`__**Anti Add Bot | ${await client.Anti_Nuke_System.get(message.guild.id+ ".antibot.enabled") ? "<a:yes:996538231644491907> Enabled ": "<:no:998643650378616963> Disabled"}**__`, `>>> [Remove Roles] **Actions / Day: \`${await client.Anti_Nuke_System.get(message.guild.id+ ".antibot.punishment.member.removeroles.neededdaycount")}\`**\n[Remove Roles] **Actions / Week: \`${await client.Anti_Nuke_System.get(message.guild.id+ ".antibot.punishment.member.removeroles.neededweekcount")}\`\n**[Remove Roles] **Actions / Month: \`${await client.Anti_Nuke_System.get(message.guild.id+ ".antibot.punishment.member.removeroles.neededmonthcount")}\`**\n\n[Kick] **Actions / Day: \`${await client.Anti_Nuke_System.get(message.guild.id+ ".antibot.punishment.member.kick.neededdaycount")}\`**\n[Kick] **Actions / Week: \`${await client.Anti_Nuke_System.get(message.guild.id+ ".antibot.punishment.member.kick.neededweekcount")}\`\n**[Kick] **Actions / Month: \`${await client.Anti_Nuke_System.get(message.guild.id+ ".antibot.punishment.member.kick.neededmonthcount")}\`**\n\n[Ban] **Actions / Day: \`${await client.Anti_Nuke_System.get(message.guild.id+ ".antibot.punishment.member.ban.neededdaycount")}\`**\n[Ban] **Actions / Week: \`${await client.Anti_Nuke_System.get(message.guild.id+ ".antibot.punishment.member.ban.neededweekcount")}\`\n**[Ban] **Actions / Month: \`${await client.Anti_Nuke_System.get(message.guild.id+ ".antibot.punishment.member.ban.neededmonthcount")}\`**`)
            ...
            for await (const ch of channels.map(this_Code_is_by_LotasDan => this_Code_is_by_LotasDan)){
              try {
                if(ch) {
