...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, es, ls, GuildSettings) => {
    ...
    try {
      ...
      if(!serverdata || !serverdata.verifychannel || serverdata.verifychannel.length < 5) return message.reply(`❌ Verification System not setupped! An Admin can enable it via: \`${prefix}s.epicgamesverify\``);
