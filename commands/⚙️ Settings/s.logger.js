...
module.exports = {
  name: "s.logger",
  category: "⚙️ Settings",
  aliases: ["slog", "slogger", "logger.s", "loggers"],
  cooldown: 5,
  usage: "s.logger  -->  React with the Emoji for the right action",
    ...
    try {
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor('Audit Logger Setup', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/apple/285/bookmark_1f516.png', 'https://discord.gg/U5r2pMuRHG')
