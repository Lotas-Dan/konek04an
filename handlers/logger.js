...
module.exports = (c) => {
      c.on("channelCreate", async function (channel) {
          send_log(c,
            ...
            "https://cdn.discordapp.com/attachments/1005180024334327859/1005180057209274480/Channel_CREATED.png"
          )
          return;
      })
      c.on("channelDelete", async function (channel) {
          send_log(c,
            ...
            "Channel DELETED",
            `**Channel:** \`${channel?.name}\`\n**ChannelID:** \`${channel.id}\`\n**ChannelTYPE:** \`${channel.type}\``,
            "https://cdn.discordapp.com/attachments/1005180024334327859/1005180692147212408/Channel_DELETED.png"
          )
          return;
      })
