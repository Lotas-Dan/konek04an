...
module.exports = {
  ...
  aliases: [""],
  cooldown: 5,
  usage: "settings  -->  React with the Emoji for the right action",
  description: "Shows all s commands",
  memberpermissions: ["ADMINISTRATOR"],
  type: "info",
  run: async (client, message, args, cmduser, text, prefix, es, ls, GuildSettings) => { // server defend
    ...
    try {
      first_layer()
        async function first_layer(){
          let menuoptions = [
            ...
            },
            {
              ...
              emoji: "<:Discord:996539552011395142>"
            },
            {
              value: "antilink",
        ...
        async function handle_the_picks(menuoptionindex, menuoptiondata) {
          require(`./setup-${menuoptiondata.value.toLowerCase()}`).run(client, message, args, cmduser, text, prefix, es, ls, GuildSettings);
        }
      } catch (e) {
