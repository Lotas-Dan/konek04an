...
module.exports = {
  name: "s.autodelete",
  category: "⚙️ Settings",
  aliases: ["sautodelete", "autodelete.s", "sautodel"],
  cooldown: 5,
  usage: "s.autodelete  --> React with the Emoji for the right action",
    ...
    try {
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.getAuthor('Auto Delete Setup', 'https://cdn.discordapp.com/emojis/834052497492410388.gif?size=96', 'https://discord.gg/U5r2pMuRHG'))
                  ...
                  try {
                    ...
                    if(a.map(d => d.id).includes(channel.id))
                      return message.reply({embeds: [new Discord.MessageEmbed()
                        .setTitle(`<:no:998643650378616963> This Channel is already Setupped!`)
                    ...
                    if(!time || isNaN(time))
                      return message.reply({embeds: [new Discord.MessageEmbed()
                        .setTitle(`<:no:998643650378616963> Invalid Input | Time wrong`)
                    ...
                    if(time > 60*60 || time < 3)
                      return message.reply({embeds: [new Discord.MessageEmbed()
                        .setTitle(`<:no:998643650378616963> Time out of Range!`)
                    ...
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      .setTitle(`<a:yes:996538231644491907> I will now delete Messages after \`${time} Seconds\` in **${channel.name}**`)
                      .setColor(es.color)
                      .setFooter(client.getFooter(es))
                    ]});
                  } catch (e) {
              ...
              .then(async collected => {
                ...
                if (channel) {
                  try {
                    ...
                    if(!a.map(d => d.id).includes(channel.id))
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      .setTitle(`<:no:998643650378616963> This Channel has not been Setup yet!`)
                      .setColor(es.color)
                      .setFooter(client.getFooter(es))
                    ]});
                    await dbRemove(client.setups, message.guild.id+".autodelete", d => d.id == channel.id)
                    return message.reply({embeds: [new Discord.MessageEmbed()
                      .setTitle(`<a:yes:996538231644491907> Successfully removed **${channel.name}** out of the Setup!`)
                      .setColor(es.color)
                      .setFooter(client.getFooter(es))
                    ]});
                  } catch (e) {
