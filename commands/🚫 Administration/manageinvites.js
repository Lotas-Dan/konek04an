...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix, es, ls, GuildSettings) => {
    ...
    try {
      ...
      let menuoptions = [
        {
          ...
          emoji: "1002958493088759828" //optional
        },
        {
          value: "Remove Joins",
        ...
        },
        {
          ...
          emoji: "998643650378616963" //optional
        },
        {
          value: "Remove Fakes",
        ...
        },
        {
          ...
          emoji: "1002958695770103928" //optional
        },
        {
          value: "Remove Leaves",
      ...
      .addField("**CURRENT INVITES:**", `<:like:996548970279084083> ${user} _**has invited __${realinvites} Member${realinvites != 1 ? "s": ""}__**_!`)
      ...
      async function menuselection(menu) {
        ...
        await menu?.reply({embeds : [new MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.la[ls].cmds.info.botfaq.menuembed.title, client.user.displayAvatarURL(), "https://discord.gg/U5r2pMuRHG")
          ...
          message.reply({embeds : [new MessageEmbed()
            .setAuthor(`New Invites of: ${user.tag}`, user.displayAvatarURL({dynamic: true}), "https://discord.gg/U5r2pMuRHG")
            .setColor(es.color).setThumbnail(es.thumb ? es.footericon && (es.footericon.includes("http://") || es.footericon.includes("https://")) ? es.footericon : client.user.displayAvatarURL() : null)
            .addField("\u200b", `<:like:996548970279084083> ${user} _**has invited __${realinvites} Member${realinvites != 1 ? "s": ""}__**_!`)
