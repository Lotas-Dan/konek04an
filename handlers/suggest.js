    ...
    module.exports.messageCreate = async (client, message, guild_settings) => {
      ...
      if (message.channel.id === feedbackchannel) {
        ...
        var embed = new MessageEmbed()
          ...
          .setColor(es.color)
          .setAuthor(client.getAuthor(message.author.tag + "' Suggestion", message.author.displayAvatarURL({ dynamic: true }), `https://discord.com/oauth2/authorize?client_id=${client.user.id}&scope=bot&permissions=837452033279`))
          .setDescription("\n" + message.content + "\n")
