...
module.exports = {
  name: "s.autobackup",
  category: "⚙️ Settings",
  aliases: ["s.backup", "sautobackup", "sbackup", "autobackup.s", "autobackups"],
  cooldown: 5,
  usage: "s.autobackup  -->  React with the Emoji for the right action",
        ...
        let menuoptions = [
          {
            ...
            emoji: GuildSettings.autobackup ? "1004118485573570580" : "❌"
          },
          {
            value: "Cancel",
