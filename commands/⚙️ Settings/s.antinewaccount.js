...
module.exports = {
  name: "s.antinewaccount",
  category: "⚙️ Settings",
  aliases: ["newaccount.s", "newaccounts", "santinewaccount", "antinewaccount.s", "antinewaccounts", "snewaccount"],
  cooldown: 5,
  usage: "s.antinewaccount  -->  React with the Emoji for the right action",
    ...
    try {
      ...
      async function first_layer(){
        let menuoptions = [
          {
            ...
            emoji: !settings.enabled ? "1004118485573570580" : "❌",
          },
          {
        ...
        let MenuEmbed = new MessageEmbed()
          .setColor(es.color)
          .setAuthor('Anti-New-Account', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/microsoft/310/hammer_1f528.png', 'https://discord.gg/U5r2pMuRHG')
