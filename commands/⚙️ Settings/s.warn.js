...
module.exports = {
  name: "s.warn",
  category: "⚙️ Settings",
  aliases: ["swarn", "warn.s", "warns", "warnsystem"],
  cooldown: 5,
  usage: "s.warn --> React with the Emoji for the right action",
    ...
    try {
      ...
      async function first_layer(){
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.getAuthor('Warn Setup', 'https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/apple/285/prohibited_1f6ab.png', 'https://discord.gg/U5r2pMuRHG'))
